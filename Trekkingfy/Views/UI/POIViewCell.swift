...
class POIViewCell: UICollectionViewCell {
    ...
    override func draw(_ rect: CGRect) { //Your code should go here.
        ...
        centreArcPerpendicular(text: "Hello round world", context: context, radius: self.layer.cornerRadius-2, angle: 0, colour: UIColor.yellow, font: UIFont.systemFont(ofSize: 12), clockwise: true)

        centreArcPerpendicular(text: "Anticlockwise", context: context, radius: self.layer.cornerRadius-10, angle: CGFloat(-M_PI), colour: UIColor.red, font: UIFont.systemFont(ofSize: 12), clockwise: false)
